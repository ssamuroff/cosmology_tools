...
from .measure_2pt_split import Measure2Point as Measure2PointSplit
from .nofz import nofz
from .nofz_split import nofz as nofzSplit 
...
stages = {
    "nofz":nofz,
    "nofz_split":nofzSplit,
    "2pt":Measure2Point,
    "2pt_split":Measure2PointSplit,
