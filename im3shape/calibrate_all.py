...
#
	...
	nbc_disc.bias_fit_vs_pts(table="%s/bias_table_hoopoe-v2-halfcat-disc.fits"%table_dir, bias_name="m", output="%s/m-vs-snr-disc-v2.png"%plots_dir)
	nbc_disc.bias_fit_vs_pts(table="%s/bias_table_hoopoe-v2-halfcat-disc.fits"%table_dir, bias_name="a", output="%s/alpha-vs-snr-disc-v2.png"%plots_dir)
	...
	plt.savefig("%s/m-vs-redshift-diagnostic-v2.png"%plots_dir)
	plt.close()
	...
	plt.savefig("%s/alpha-vs-redshift-diagnostic-v2.png"%plots_dir)
	plt.close()
