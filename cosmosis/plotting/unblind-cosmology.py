...
class plot2D(plots.MetropolisHastingsPlots2D):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.colors=["firebrick","royalblue","purple", "plum",'firebrick', "royalblue", "purple","deeppink", "pink"]
        self.linestyles=['-','--',':','-']
        ...
        x0 = 0.13* (1 + blindx)
        y0 = 0.4 * (1 + blindy)
        self.axis=[0.1,0.5, 0.4,1.2] #[0.233,0.45,0.65,1.1]
        ...
        self.alphas=[0.6,0.6,0.6,0.3]*len(self.colors)
    ...
    def run(self):
        name2="cosmological_parameters--sigma_8"
    ...
    def make_2d_plot(self, name1, name2):
        ...
        pylab.xlabel(r"$\Omega_\mathrm{m}$", fontsize=28)
        pylab.ylabel(r"$\sigma_8$", fontsize=28)
        pylab.tight_layout()
        if blind:
