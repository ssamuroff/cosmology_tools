...
class plot2D(plots.MetropolisHastingsPlots2D):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.colors=['pink', "slateblue","purple"]
        self.linestyles=['-','-','-.','-']
        self.labels=["halfchain 1", "halfchain 2", "full chain"]
        self.axis=[0.15,0.5, 0.5,1.1]#[0.233,0.45,0.65,1.1]
        self.fill_list=[True,True,False]*10
        self.line_list=[True,True,True]*10
        self.opaque_list=[True,True,False]*10
        self.linewidths=[1.5]*len(self.colors)
        self.alphas=[0.4,0.4,0.0]*len(self.colors)
        self.imshow=[False]*10
        self.linecolors=[None]*10
        self.opaque_centre=[False]*10
        self.fill_colors=[None,None]*10
        self.plot_points=[(0.3156,0.80847)]
        #self.proxies=[]
